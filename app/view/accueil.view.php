...
<body>
    ...
    <div class="bande">
        <h2>Notre but est de vous faire découvrir des bières originales et artisanales en bord de mer.</h2>
    </div>
    <div class="vagues">
        <img src="public/images/vaguesbleubas.svg"/>
    </div> 
    <main>
        <div class="notrebrasserie">
            <img src="public/images/Imagebar.png"/>
        </div>
        <aside>
            <h3>Notre brasserie</h3>
            <p>Vous vous demandez sûrement qui est Mitch ? Mitch est un jeune homme de 63 ans,c’est un passionné de surf depuis son voyage en California en 82.
                Après un long moment à dominer les vagues, Mitch a décidé de cesser son activité et de revenir à son oasis d’origine: la Bretagne, en apportant planche et souvenirs.
                “Chez Mitch” est une brasserie de bord de mer à l’image chill et amicale, qui souhaite retranscrire un moment de partage sans prise de tête !
                La bière, conviviale et apéritive est la boisson idéale pour partager un moment agréable.  
                Alors, si vous souhaitez juste faire un break, vous poser, et vous éloigner du quotidien : rendez-vous chez Mitch ! </p>
            <button href="">En savoir plus</button>
        </aside>
    </main>
