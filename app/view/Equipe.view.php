 <section id="section" class="active">
            ...
            <div class="Lechefdeprojet">
                ...
                <div class="vague">
                <img  src="public/images/Vague Verticale bleu.svg" alt=""></div>
            ...
            <div class="Lescommunitymanager">
                ...
                <div><img class="gensilu" id="lili" src="public/images/Lilirose.png" alt="">
                <img class="gensilu" id="lisa" src="public/images/lisa.png" alt=""></div>
                <p class="comp">Compétences :
                    dire des choses réels et drôle pour dynamiser</p>
            </div>
            <div class="Lesdévloppeurs">
                ...
                <img class="gensilu" id="nath" src="public/images/Nath.png" alt=""></div>
                <p class="comp">Compétences :
                    dire des choses réels et drôle pour dynamiser</p>
            </div>
            <div class="Nossuperbesbrasseurs">
                ...
                <img class="gensilu" id="pierre" src="public/images/Pierre.png" alt=""></div>
                <p class="comp">Compétences :
                    dire des choses réels et drôle pour dynamiser</p>
            </div>
        </section>